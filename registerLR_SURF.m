...
function registerLR_SURF(Parent, xy, xml_files, fpath, nm, pos, D, filename, lgr, smcrop, pixel_region_sf)
...
% YOU ARE HERE- Reading in region on level4 with scaled pixel_region works!
        %read in nuc file and get image info
        nuc_ref = imread(image,4,'PixelRegion', pixel_region_sf{2});
